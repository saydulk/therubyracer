module CountryCodes
  ...
  COUNTRY_CODES = [
    ...
    { name: 'Holy See (Vatican City State)', dial_code: '+39', code: 'VA' },
    ...
    { name: 'Paraguay', dial_code: '+592', code: 'PY' },
  ...
  def get_all_country_codes
    COUNTRY_CODES.map{ |k| ["#{k[:dial_code]}  ( #{k[:name]} )", k[:code]]}
  end

  def country_specific_code(country_code)
    COUNTRY_CODES.reject{ |k| k[:code].casecmp(country_code) != 0 }.first
  end
end