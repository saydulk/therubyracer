# -*- encoding: utf-8 -*-
# stub: padrino-cache 0.14.2 ruby lib

Gem::Specification.new do |s|
  s.name = "padrino-cache".freeze
  s.version = "0.14.2"
  ...
  s.date = "2018-01-02"
  s.description = "Caching support for memcached, page and fragment".freeze
  ...
  s.summary = "Page and fragment caching for Padrino".freeze
