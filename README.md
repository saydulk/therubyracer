# Coinchel -crypto currency exchange
...
### [coinchel.hk](https://coinchel.hk/) fork

Coinchel is a crypto currency exchange implementation with the Rails framework and other cutting-edge technology.
...
Coinchel front-end based Bootstrap 3.0 version and Sass, and you can custom exchange style for your mind.

* change bootstrap default variables in `vars/_bootstrap.css.scss`
* change Coinchel custom default variables in `vars/_basic.css.scss`
...
Coinchel is released under the terms of the [MIT license]


**[This illustration copyright for Coinchel Team]**
