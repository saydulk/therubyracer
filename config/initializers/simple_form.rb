...
SimpleForm.setup do |config|
  ...
  config.wrappers :default, class: 'form-group',
    ...
    ## Inputs
    #
    b.use :label, wrap_with: { tag: :div, class: 'col-xs-12 page_label'}
    b.use :input, wrap_with: { tag: :div, class: 'page_input_Sec'}
    b.use :full_error, wrap_with: { tag: :span, class: 'error text-danger  page_error col-xs-12' }
    b.use :hint,  wrap_with: { tag: :span, class: 'hint col-xs-12 page_hint' }
  end
