window.GlobalData = flight.component ->
  ...
  @refreshTicker = (data) ->
    ...
    tickers = for market, ticker of data
      continue if @.last_tickers[market] == undefined
      ...
      if market == gon.market.id
        console.log "gon.market.id==============   "+gon.market.id
        console.log "buy==============   "+ buy
        console.log "sell==============   "+ sell
        console.log "last==============   "+ last
        console.log "tickers==============   "+ tickers
        console.log "ticker==============   "+ ticker
        console.log "@.last_tickers[market].buy==============   "+last_buy
        console.log "@.last_tickers[market].sell==============   "+ last_sell
        console.log "@.last_tickers[market].last==============   "+ last_last
  ...
  @after 'initialize', ->
    ...
    market_channel.bind 'update', (data) =>
      ...
      @trigger 'market::order_book::update', asks: data.asks.reverse(), bids: data.bids
    ...
    if gon.asks and gon.bids
      @trigger 'market::order_book::update', asks: gon.asks.reverse(), bids: gon.bids
