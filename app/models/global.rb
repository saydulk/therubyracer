class Global
  ...
  def ticker
    ...
    best_buy_price   = (bids.first && bids.first[0] || ZERO) rescue ZERO
    best_sell_price  = (asks.first && asks.first[0] || ZERO) rescue ZERO
    market_dollar_price = (Rails.cache.read "peatio:#{currency}:dollar_price") || ZERO
    ...
    ticker.merge({
      ...
      buy: best_buy_price,
      at: at,
      unit_price: market_dollar_price.to_f
    })
  end
