...
module APIv2
  class Mount < Grape::API
    ...
    # Mobile APIs Routing
    mount MobileApi::Register
    mount MobileApi::Auth
    mount MobileApi::TwoFactor
    mount MobileApi::ResetPassword
    mount MobileApi::Profile
    mount MobileApi::FundSources
    mount MobileApi::Withdraws
    mount MobileApi::Favorites
